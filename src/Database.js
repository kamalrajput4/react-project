    ...
    return (
        <>
            <input
                ...
                className="border border-gray-300 rounded px-4 py-2 m-2 "
            />
                ...
                <tbody>
                    {
                        Object.keys(obj).map(function (value) {
                            return (
                                <tr key={value} className="text-center hover:bg-gray-100">
                                    <td className="border border-gray-400 px-4 py-2">{obj[value].Name}</td>
                                    <td className="border border-gray-400 px-4 py-2">{obj[value].Phone}</td>
                                    <td className="border border-gray-400 px-4 py-2">{obj[value].Address}</td>
                                </tr>
                            )
                        })
                    }
